...
import BarberProfileView from './pages/BarberProfileView';
    ...
    <div className="min-h-screen bg-[#1a1a2e] text-[#eaeaea] font-sans selection:bg-[#e94560] selection:text-white flex flex-col">
      ...
      <main className={clsx(
        ...
        <Routes>
          ...
          <Route path="/barber-profile" element={<ProtectedRoute allowedRoles={['barber']}><BarberProfileView /></ProtectedRoute>} />
        </Routes>
      </main>
    </div>
  );
